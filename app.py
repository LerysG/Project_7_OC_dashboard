...
if rad == '🏠 Home':
    with header:
        ...
        st.markdown("This project was composed of two main objectives: <br> \
            - Develop a scoring machine learning model to predict the solvency of clients of a bank-like company (i.e. probability of credit payment failure).\
                It is therefore a **binary classification issue**. Class 0 is solvent client whereas class 1 represents clients with payment difficulties. <br>\
